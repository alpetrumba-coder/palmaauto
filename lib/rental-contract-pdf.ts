...
function buildDocDefinition(input: RentalContractPdfInput) {
  ...
  const content: any[] = [
    ...
    {
      text: `ООО «ТДР», именуемое в дальнейшем «Арендодатель», в лице Генерального директора Библая Вячеслава Арвелодовича, действующего на основании Устава, с одной стороны, и гражданин(ка) ${m.fullName}, ${m.birthYear} г.р., паспорт: ${m.passportSeries} ${m.passportNumber}, выдан ${m.passportIssuedBy}, именуемый(ая) в дальнейшем «Арендатор», с другой стороны, заключили настоящий договор о нижеследующем:`,
      style: "small",
      margin: [0, 0, 0, 8],
    },
